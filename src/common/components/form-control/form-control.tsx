...
const CustomDateInput = forwardRef(function CustomDateInput(forwardedProps: any, inputRef) {
...
const ExpirationDateInput = forwardRef<HTMLInputElement, ExpirationInputControlProps>(
  function ExpirationDateInput(props, inputRef) {
...
export const FormattedDateInput = forwardRef<DatePickerRef, DateInputProps>(
          ...
          <DatePicker
            ...
            onChange={(date) => {
              const formatted = date
                ? formatter.date(dayjs(date).format(DatepickerDateFormat))
                : "";
...
export const CustomFormattedDateInput = forwardRef<DatePickerRef, DateInputProps>(
  function CustomFormattedDateInput(props, ref) {
    const {
      selectedDate,
      id,
      label,
...
const TimeInput = forwardRef<HTMLInputElement, TimeInputControlProps>(
...
const FloatingLabelInput = forwardRef<HTMLInputElement, InputControlProps>(
...
const FloatingLabelTextArea = forwardRef<HTMLTextAreaElement, TextAreaControlProps>(
  function FloatingLabelTextArea(props, ref) {
...
const Input = forwardRef<HTMLInputElement, InputControlProps>(function Input(props, ref) {
  const {
    id,
    label,
    type = "text",
...
const FormattedPhoneInput = forwardRef<HTMLInputElement, PhoneInputControlProps>(
  function FormattedPhoneInput(props, ref) {
...
const Select = forwardRef<HTMLSelectElement, SelectControlProps>(function Select(props, ref) {
...
const SelectOption = forwardRef<HTMLOptionElement, SelectOptionControlProps>(
...
const TextArea = forwardRef<HTMLTextAreaElement, TextAreaControlProps>(
...
const FileInput = forwardRef<HTMLInputElement, FileInputControlProps>(
